 ...
 * - Exposes service AB00 with characteristic AB01 for WiFi credentials
 * - Characteristic accepts JSON: {"ssid":"Your Network","password":"Your Password"}
...
/**
 * Check if WiFi credentials were just received via BLE.
